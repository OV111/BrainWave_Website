  ...
  return (
    <section id="collabs" className="relative">
      <div className="container pt-10 lg:flex">
        ...
        {/* Left-Side */}
        <div className="relative flex flex-col lg:flex-row items-start justify-between px-6 md:px-12 lg:ml-15 pt-15">
          <div className="flex-1 max-w-2xl mb-10 lg:mb-0 lg:pr-10">
            ...
            <ul>
              <li className="pb-4">
                ...
                <p className="w-90 max-w-90 text-lg text-[#ADA8C3]">
            ...
            <Button className="cursor-pointer mt-15 font-mono text-[#CAC6DD] hover:text-white lg:flex">
              Try It Now
            </Button>
          </div>
        </div>
        ...
        <div className="grid grid-col-1 lg:ml-auto xl:w-[38rem] mt-15 gap-30">
          <div className="flex justify-center">
            <p className="text-[#ADA8C3] w-90 max-w-150 text-lg">
